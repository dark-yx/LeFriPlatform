              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-neutral-600">Consultas realizadas</span>
                    <span className="text-lg font-bold text-blue-500">
                      {consultations?.length || 0}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-neutral-600">Procesos iniciados</span>
                    <span className="text-lg font-bold text-orange-600">
                      {processes?.length || 0}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-neutral-600">Tiempo total</span>
